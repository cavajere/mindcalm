...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/register', component: () => import('../views/RegisterView.vue'), meta: { publicOnly: true } },
    ...
    { path: '/audio/:id', component: () => import('../views/AudioDetailView.vue') },
    { path: '/posts', component: () => import('../views/PostsView.vue') },
    { path: '/posts/:slug', component: () => import('../views/PostDetailView.vue') },
