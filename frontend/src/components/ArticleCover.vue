...
<template>
  <div :class="containerClass">
    ...
    <div
      v-else
      class="flex h-full w-full flex-col justify-between bg-gradient-to-br from-primary/10 via-background to-secondary/10 p-5"
      :class="placeholderClass"
      aria-hidden="true"
    >
      <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-white/70 text-primary shadow-sm dark:bg-slate-900/50">
      ...
      <div>
        <p class="text-xs font-semibold uppercase tracking-[0.22em] text-text-secondary">MindCalm Journal</p>
