...
const iframeUrl = computed(() => selectedDocument.value?.url || pageConfig.value.fallbackUrl)
...
<template>
  <div class="page-container space-y-8 pb-10">
    ...
    <section v-else-if="selectedDocument" class="surface-card overflow-hidden p-4 sm:p-6">
      <iframe
        :src="iframeUrl"
        :title="selectedDocument.title"
        class="h-[72vh] w-full rounded-[24px] border border-ui-border bg-white"
      />
    </section>
