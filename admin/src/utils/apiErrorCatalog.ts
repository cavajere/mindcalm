export const API_ERROR_MESSAGES: Record<string, string> = {
  ...
  LICENSE_EXPIRED: 'La licenza di questo utente è scaduta.',
  ...
  REGISTRATION_RATE_LIMITED: 'Troppe richieste di registrazione. Riprova tra qualche minuto.',
  REGISTRATION_VERIFY_RATE_LIMITED: 'Troppi tentativi di conferma. Riprova tra qualche minuto.',
  INVITE_CODE_RATE_LIMITED: 'Troppi tentativi di verifica del codice. Riprova tra qualche minuto.',
  EVENT_BOOKING_ACCESS_RATE_LIMITED: 'Troppi tentativi di accesso prenotazione. Riprova tra qualche minuto.',
