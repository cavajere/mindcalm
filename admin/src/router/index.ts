...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/posts', component: () => import('../views/PostsListView.vue'), meta: { requiresAuth: true } },
    { path: '/posts/new', component: () => import('../views/PostFormView.vue'), meta: { requiresAuth: true } },
    { path: '/posts/:id/edit', component: () => import('../views/PostFormView.vue'), meta: { requiresAuth: true } },
