...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/thoughts', component: () => import('../views/ThoughtsListView.vue'), meta: { requiresAuth: true } },
    { path: '/thoughts/new', component: () => import('../views/ThoughtFormView.vue'), meta: { requiresAuth: true } },
    { path: '/thoughts/:id/edit', component: () => import('../views/ThoughtFormView.vue'), meta: { requiresAuth: true } },
    ...
    { path: '/communications/campaigns', component: () => import('../views/CommunicationCampaignsView.vue'), meta: { requiresAuth: true } },
    { path: '/communications/contacts', component: () => import('../views/CommunicationContactsView.vue'), meta: { requiresAuth: true } },
    { path: '/communications/contacts/:id', component: () => import('../views/CommunicationContactDetailView.vue'), meta: { requiresAuth: true } },
    { path: '/communications/consents', component: () => import('../views/CommunicationConsentsView.vue'), meta: { requiresAuth: true } },
    { path: '/communications/suppressions', component: () => import('../views/CommunicationSuppressionsView.vue'), meta: { requiresAuth: true } },
